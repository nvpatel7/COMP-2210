...
*/
   ...
   public static <T> T max(Collection<T> coll, Comparator<T> comp) {
      if (coll == null || comp == null) {
         throw new IllegalArgumentException("The collection or comparator is null.");
      }
   ...
   public static <T> T kmin(Collection<T> coll, int k, Comparator<T> comp) {
      ...
      if (count < k || k < 1) {
         throw new NoSuchElementException("k value is invalid");
      }
   ...
   public static <T> T kmax(Collection<T> coll, int k, Comparator<T> comp) {
      if (coll == null || comp == null) {
         throw new IllegalArgumentException("The collecion or comparator is null.");
      }
   ...
   public static <T> Collection<T> range(Collection<T> coll, T low, T high,
      ...
      if (x.size() == 0) {
         throw new NoSuchElementException("No values fall into specified range.");
      }
